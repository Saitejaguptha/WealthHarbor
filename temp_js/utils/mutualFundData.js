...
exports.getMutualFunds = exports.refreshMutualFunds = exports.generateRandomMFs = exports.FUND_HOUSES = exports.MF_SECTORS = void 0;
...
const generateRandomMFs = () => {
    ...
    return Array.from({ length: mfNames.length }).map((_, i) => {
        ...
        const house = exports.FUND_HOUSES.find(h => name.startsWith(h.split(' ')[0])) || exports.FUND_HOUSES[i % exports.FUND_HOUSES.length];
        const sector = exports.MF_SECTORS[i % exports.MF_SECTORS.length];
        ...
        return {
            ...
            history: (0, historyUtils_1.generatePriceHistory)(nav)
        };
    });
};
exports.generateRandomMFs = generateRandomMFs;
let cachedMFs = null;
const refreshMutualFunds = () => {
    cachedMFs = (0, exports.generateRandomMFs)();
    return cachedMFs;
};
exports.refreshMutualFunds = refreshMutualFunds;
