...
import { MF_SECTORS, FUND_HOUSES } from '../../types/mutualFund';
...
export const getMutualFunds = (): MutualFund[] => {
    if (!cachedMFs) cachedMFs = generateRandomMFs();
    return cachedMFs;
};

export const refreshMutualFunds = (): MutualFund[] => {
