...
export const getAllCommodities = (): CommodityData[] => {
    if (!cachedCommodities) cachedCommodities = getCommodities();
    return cachedCommodities;
};

export const refreshCommodities = (): CommodityData[] => {
    cachedCommodities = getCommodities();
    return cachedCommodities;
};

export const getCommodityById = (id: string): CommodityData | undefined =>
    getAllCommodities().find(c => c.id === id);
