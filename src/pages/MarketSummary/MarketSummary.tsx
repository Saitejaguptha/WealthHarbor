        ...
        <div className="h-full flex flex-col p-3 md:p-6 w-full overflow-hidden bg-indigo-50/20">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 md:gap-4 mt-3 md:mt-4 flex-1 min-h-0 overflow-y-auto lg:overflow-hidden pb-4 lg:pb-0 custom-scrollbar stagger-children">
                ...
                <div className="lg:col-span-2 flex flex-col min-h-[300px] lg:min-h-0 lg:h-full">
                    <div className="bg-white/80 backdrop-blur-xl border border-white rounded-[2rem] md:rounded-[2.5rem] p-5 md:p-6 shadow-2xl shadow-indigo-100/30 flex flex-col min-h-0 lg:h-full overflow-visible lg:overflow-hidden">
                        ...
                        <div className="space-y-2 md:space-y-2.5 overflow-visible lg:overflow-y-auto pr-2 custom-scrollbar flex-1 min-h-0">
