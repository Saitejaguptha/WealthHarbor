    ...
    return (
        <div className="p-3 md:p-10 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-1000 space-y-6 md:space-y-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
                ...
                <div className="bg-white/70 backdrop-blur-xl border border-white p-4 md:p-8 rounded-[1.25rem] md:rounded-[2.5rem] shadow-xl shadow-indigo-100/30 space-y-4 md:space-y-8 overflow-hidden">
                    <div className="flex items-center gap-3 pb-3 border-b border-indigo-50">
                        ...
                        <h2 className="text-lg md:text-2xl font-bold text-indigo-950 tracking-tight truncate">Personal Details</h2>
                    </div>
                    ...
                    <form onSubmit={handleSaveProfile} className="space-y-4 md:space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <FiEdit2 className="absolute left-3 md:left-4 top-1/2 -translate-y-1/2 text-indigo-300 group-focus-within:text-indigo-600 transition-colors text-xs md:text-base" />
                                <input
                                    type="text"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group w-full overflow-hidden">
                                <input
                                    ...
                                    className="w-full px-4 py-3 md:py-4 bg-white border-2 border-indigo-50 rounded-xl md:rounded-2xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all font-semibold text-indigo-950 text-xs md:text-base min-w-0 box-border appearance-none"
                ...
                {/* Security / Password */}
                <div className="bg-white/70 backdrop-blur-xl border border-white p-4 md:p-8 rounded-[1.25rem] md:rounded-[2.5rem] shadow-xl shadow-indigo-100/30 space-y-4 md:space-y-8 flex flex-col justify-between overflow-hidden">
                    <div>
                        <div className="flex items-center gap-3 pb-3 border-b border-indigo-50 mb-4 md:mb-8">
                            <div className="p-2 bg-indigo-600 text-white rounded-lg md:rounded-2xl shadow-lg shadow-indigo-600/20 shrink-0">
                                <FiLock className="text-base md:text-xl" />
                            </div>
                            <h2 className="text-lg md:text-2xl font-bold text-indigo-950 tracking-tight truncate">Security</h2>
                        </div>

                        <div className="space-y-4 md:space-y-6">
                            <div className="space-y-1">
                                <label className="text-[9px] md:text-sm font-black text-indigo-900/40 uppercase tracking-widest ml-1">Current Password</label>
                                <input
                                    type="password"
                                    value={passwords.current}
                                    onChange={(e) => setPasswords({ ...passwords, current: e.target.value })}
                                    className="w-full px-4 md:px-6 py-3 md:py-4 bg-white border-2 border-indigo-50 rounded-xl md:rounded-2xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-500/10 outline-none transition-all font-semibold text-indigo-950 text-xs md:text-base placeholder:text-indigo-200 min-w-0"
                                    placeholder="••••••••"
                                />
                            </div>
                            ...
                            <div className="space-y-1">
                                <label className="text-[9px] md:text-sm font-black text-indigo-900/40 uppercase tracking-widest ml-1">Confirm Password</label>
                                <input
                                    type="password"
                    ...
                    <button className="w-full mt-4 md:mt-8 py-3.5 md:py-4 bg-indigo-600 text-white rounded-xl md:rounded-2xl font-black hover:bg-indigo-700 shadow-lg shadow-indigo-200 hover:shadow-indigo-300 transition-all active:scale-95 text-xs md:text-base">
                        Update Password
                    </button>
                </div>
            </div>
            ...
            <div className="bg-white/40 backdrop-blur-md border border-white p-4 md:p-6 rounded-[1.25rem] md:rounded-[2rem] flex items-center gap-3 text-indigo-900/60 font-medium text-[10px] md:text-sm">
                ...
                Your data is securely stored locally and encrypted.
            </div>
        </div>
    );
};
